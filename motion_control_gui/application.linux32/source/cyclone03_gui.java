...
public class cyclone03_gui extends PApplet {
...
public void setup()
{
  ...
  controlP5.addButton("Send_PID",0.0f,10,475,60,20);         //

  controlP5.addButton("Send_SP",0.0f,10,240,60,20);         //
  controlP5.addButton("Stop",0.0f,110,320,40,20);
...
public void drawGraph()
{
  ...
  if(millis() > nextRefresh && madeContact)
  {
    ...
    CurrentData[0] = PApplet.parseInt(outputHeight)-PApplet.parseInt(outputHeight*(Current-OutScaleMin)/(OutScaleMax-OutScaleMin));
    WaveformDataE[0] = PApplet.parseInt(outputHeight)-PApplet.parseInt(outputHeight*(WaveformE-OutScaleMin)/(OutScaleMax-OutScaleMin));
...
public void Stop()
{
  ...
  String msg = "gui " + a + " " + d + " " + 
               "0.0" + " " +    //setpoint
               PApplet.parseFloat(InField.getText()) + " " +
               PApplet.parseFloat(OutField.getText()) + " " +
               PApplet.parseFloat(PField.getText()) + " " +
               PApplet.parseFloat(IField.getText()) + " " +
               PApplet.parseFloat(DField.getText()) + 
               "\r\n";
  myPort.write(msg);
  print(msg);
  justSent=true;
  controlP5.getController("SPslider").setValue(0.0f);
}
...
public void Send_SP()
{
  ...
  Byte d = (DRLabel.valueLabel().getText()=="Direct")?(byte)0:(byte)1;
  String msg = "gui " + a + " " + d + " " + 
               PApplet.parseFloat(SPField.getText()) + " " +
               PApplet.parseFloat(InField.getText()) + " " +
               PApplet.parseFloat(OutField.getText()) + " " +
               PApplet.parseFloat(PField.getText()) + " " +
               PApplet.parseFloat(IField.getText()) + " " +
...
public void Send_To_Arduino_Old()
{
...
public void serialEvent(Serial myPort)
{
  ...
  if (s.length == 11) //10) //9
  {
    ...
    //red
    Setpoint = map(PApplet.parseFloat(s[2]), -1500.0f, 1500.0f, InScaleMin, InScaleMax);
    //grn
    Input = map(PApplet.parseFloat(s[3]), -1500.0f, 1500.0f, InScaleMin, InScaleMax);
    //blu
    Output = map(PApplet.parseFloat(s[10]), -500.0f, 500.0f, OutScaleMin, OutScaleMax);
    //cyan
    Current = map(PApplet.parseFloat(s[1]), -1000.0f, 15000.0f, OutScaleMin, OutScaleMax);
    
    WaveformE = map(PApplet.parseFloat(s[9]), -1000.0f, 15000.0f, OutScaleMin, OutScaleMax); 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cyclone03_gui" };
    if (passedArgs != null) {
